...
file_aboslute_address = os.path.abspath("Broad_Just_Input_Dataset_Creator_f.py")
file_adress = re.escape( file_aboslute_address.replace( 'Broad_Just_Input_Dataset_Creator_f.py', '' ) ).replace( '\:', ':' )
