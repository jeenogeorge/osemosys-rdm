...
def execute_local_dataset_creator_0_outputs(file_adress):
    ...
    for n in range( len( case_list ) ):
        filename = os.path.join(file_adress, case_list[n], case_list[n] + '_Output.csv')
        #
        line_count = 0
    ...
    csv_path = os.path.join(file_adress, 'output_dataset_0.csv')
...
def execute_local_dataset_creator_0_inputs(file_adress):
    ...
    #
    for n in range( len( case_list ) ):
        filename = os.path.join(file_adress, case_list[n], case_list[n] + '_Input.csv')
        #
        line_count = 0
        with open( filename ) as csv_file:
            csv_reader = csv.reader(csv_file, delimiter=',')
    ...
    #
    frame = pd.concat(li, axis=0, ignore_index=True)
    csv_path = os.path.join(file_adress, 'input_dataset_0.csv')
    export_csv = frame.to_csv ( csv_path, index = None, header=True)
############################################################################################################################
def execute_local_dataset_creator_0_prices(file_adress):
    ...
    #
    frame = pd.concat(li, axis=0, ignore_index=True)
    csv_path = os.path.join(file_adress, 'price_dataset_0.csv')
    export_csv = frame.to_csv ( csv_path, index = None, header=True)
############################################################################################################################
def execute_local_dataset_creator_0_distribution(file_adress):
    ...
    #
    for n in range( len( case_list ) ):
        filename = os.path.join(file_adress, case_list[n], case_list[n] + '_Distribution.csv')
        #
        line_count = 0
        with open( filename ) as csv_file:
            csv_reader = csv.reader(csv_file, delimiter=',')
    ...
    #
    frame = pd.concat(li, axis=0, ignore_index=True)
    csv_path = os.path.join(file_adress, 'distribution_dataset_0.csv')
    export_csv = frame.to_csv ( csv_path, index = None, header=True)
############################################################################################################################
